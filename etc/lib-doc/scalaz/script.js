...
// $Id: script.js 13112 2007-10-19 12:34:30Z michelou $
...
var scalaz_version = '2.3';
var scalaz_api_root = 'http://projects.workingmouse.com/public/scalaz/artifacts/' + scalaz_version + '/scaladoc/';
...
function get_api_root(key) {
  ...
  else if (key.indexOf("scalaz/"      ) == 0) { root = scalaz_api_root; }
  return root;
}
...
var scalaz_src_root = 'http://projects.workingmouse.com/public/scalaz/tags/' + scalaz_version + '/src/main/';
...
function get_src_root(key) {
  ...
  else if (key.indexOf("scalaz/"       ) == 0) { root = scalaz_src_root; }
